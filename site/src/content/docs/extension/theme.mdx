...
- **Dark Mode**: Reduces eye strain in low‑light environments and can save battery on OLED displays.
  <img class="d-block mb-4 img-fluid rounded-3" src="/docs/[[config:docs_version]]/assets/img/dark-theme.png" alt="" />
- **Light Mode**: Bright, clear interface—ideal for well‑lit environments.
  <img class="d-block mb-4 img-fluid rounded-3" src="/docs/[[config:docs_version]]/assets/img/light-theme.png" alt="" />
