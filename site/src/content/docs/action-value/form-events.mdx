  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>
      Our program features an intelligent click behavior that ensures elements are clicked only once, if the page is not fully refreshed. Let’s illustrate this with an example:
