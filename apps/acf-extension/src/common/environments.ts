...
export { API_SECRET, DISCORD_CLIENT_ID, EDGE_OAUTH_CLIENT_ID, FIREBASE_API_KEY, FIREBASE_PROJECT_ID, FUNCTION_URL, MEASUREMENT_ID, OPTIONS_PAGE_URL, UNINSTALL_URL, VARIANT };
