...
import { Configuration, LOAD_TYPES, START_TYPES, defaultConfig } from '@dhruv-techapps/acf-common';
...
const ConfigSettingsModal = forwardRef<Ref, Props>(({ config, configIndex, setConfigs }, ref) => {
