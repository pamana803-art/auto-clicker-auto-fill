...
import { Addon, RECHECK_OPTIONS } from '@dhruv-techapps/acf-common';

type Props = {
  addon: Addon;
  onUpdate: (event: React.SyntheticEvent) => void;
};

function AddonRecheck({ addon: { recheck, recheckInterval, recheckOption }, onUpdate }: Props) {
