...
import { ACTION_CONDITION_OPR, ACTION_STATUS, Action, ActionCondition } from '@dhruv-techapps/acf-common';
import { X } from '../../util';
...
type Props = {
  ...
  setConditions: Dispatch<SetStateAction<Array<ActionCondition>>>;
  updateRef:any
};

function ActionAndStatus({ actions, condition: { actionIndex, status,operator },  updateRef, conditionIndex, setConditions }: Props) {
